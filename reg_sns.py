...
def set_axes_labels(axes):
    ...
    axes.set_xlabel(xlabel='DFT Calculated $\Delta $ E(eV)', fontsize=15, weight='bold')
    return
...
ax.annotate(f'$R^2$ = 0.985',
            xy=(0.08, 0.95),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
ax.annotate(f'RMSE = 0.0416',
            xy=(0.08, 0.89),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
...
modify_axes_labels(ax)
modify_grid_axes_width(grid)
ax.annotate(f'$R^2$ = 0.994',
            xy=(0.08, 0.95),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
ax.annotate(f'RMSE = 0.0609',
            xy=(0.08, 0.89),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
...
modify_axes_labels(ax)
modify_grid_axes_width(grid)
ax.annotate(f'$R^2$ = 0.99',
            xy=(0.08, 0.95),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
ax.annotate(f'RMSE = 0.162',
            xy=(0.08, 0.89),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
...
modify_axes_labels(ax)
modify_grid_axes_width(grid)
ax.annotate(f'$R^2$ = 0.993',
            xy=(0.08, 0.95),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
ax.annotate(f'RMSE = 0.142',
            xy=(0.08, 0.89),
            xycoords='axes fraction',
            horizontalalignment='left', verticalalignment='top',
            fontsize=12, weight="bold")
